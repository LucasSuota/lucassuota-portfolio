...
export const projects: Project[] = [
  {
    ...
    platform: 'desktop',
    imageUrl: '../../src/assets/projects-photos/concrete-app.png',
    galleryUrls: [
      '../../src/assets/projects-photos/Concrete Management App/1.png',
      '../../src/assets/projects-photos/Concrete Management App/2.png',
      '../../src/assets/projects-photos/Concrete Management App/3.png',
      '../../src/assets/projects-photos/Concrete Management App/4.png',
      '../../src/assets/projects-photos/Concrete Management App/5.png',
      '../../src/assets/projects-photos/Concrete Management App/6.png',
      '../../src/assets/projects-photos/Concrete Management App/7.png',
      '../../src/assets/projects-photos/Concrete Management App/8.png',
    ],
    featured: true,
  },
  {
    ...
    stack: ['React', 'TypeScript', 'Electron', 'SQLite'],
    platform: 'desktop',
    imageUrl: '../../src/assets/projects-photos/Spt App/1.png',
    galleryUrls: [
      '../../src/assets/projects-photos/Spt App/1.png',
      '../../src/assets/projects-photos/Spt App/2.png',
    ],
    featured: true,
  },
  {
    ...
    platform: 'web',
    imageUrl: '../../src/assets/projects-photos/proquality-website.png',
    featured: false,
  },
];
